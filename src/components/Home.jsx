  ...
  return (
      <div className="w-full h-screen py-[350px]">
        ...
        <div className="max-w-[1000px] mx-auto flex flex-col justify-center h-full px-6 gap-4 on-top">
          ...
          <div>
            <button href="#about" type="button" className="text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#4dc251] hover:border-[#4CAF50] transition ease-in-out delay-150   hover:-translate-y-1 hover:scale-110 duration-300"> Sobre mim!
